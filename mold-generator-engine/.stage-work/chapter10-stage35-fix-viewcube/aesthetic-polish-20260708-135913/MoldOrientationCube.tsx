    ...
    <aside className="mold-viewcube" aria-label="View orientation cube">
      ...
      >
        ...
        <g className="mold-viewcube__body" filter="url(#mold-viewcube-shadow)">
          ...
          <polyline className="mold-viewcube__edge" points="70,30 103,47 103,86 70,104 37,86 37,47 70,30 70,64 103,47" />
          <polyline className="mold-viewcube__edge mold-viewcube__edge--soft" points="70,64 37,47" />

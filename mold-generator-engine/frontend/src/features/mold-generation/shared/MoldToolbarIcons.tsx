 ...
 * (SplitFaceControls, SegmentationModeBar, MoreMoldsToolbar). Owned by no
...
export function PartitioningIcon() {
  return (
    <svg
      aria-hidden="true"
      className={styles.icon}
    ...
    >
      <path
        d="M3.5 5.5 8 3h6v16l-4 2H3.5V5.5Z"
        fill="currentColor"
        fillOpacity="0.24"
        stroke="currentColor"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M19 5.5 23 3h3.5v16l-4 2H19V5.5Z"
        fill="currentColor"
        fillOpacity="0.14"
        stroke="currentColor"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M16.5 3.5v2.2m0 2.1V10m0 2.1v2.2m0 2.1v2.2m0 2.1v.3"
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="1.6"
      />
...
export function ManualIcon() {
  return (
    <ToolbarIcon>
      <path
        d="M8 13.5V6a1.5 1.5 0 0 1 3 0v5.5M11 11V4.5a1.5 1.5 0 0 1 3 0V11m-3-6.5V13"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.4"
      />
      <path
        d="M14 6.5a1.5 1.5 0 0 1 3 0V13M8 13.5 6.3 12a1.4 1.4 0 0 0-2 1.9l3.2 4.4A5 5 0 0 0 11.5 20.5h1.6a5 5 0 0 0 5-5v-3.8"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.4"
